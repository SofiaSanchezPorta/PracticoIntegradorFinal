...
def validate_image_size(image): #COMPRUEBA QUE NO SUPERE UN LÍMITE EL TAMAÑO DE LA IMAGEN 
    filesize = image.file.size
    megabyte_limit = 5.0
    if filesize > megabyte_limit * 1024 * 1024:
        raise ValidationError(f"El tamaño máximo permitido es de {megabyte_limit} MB")

def get_image_path(instance, filename): #PARA QUE NOS DEVUELVA LA UBICACIÓN EXACTA DE UN ARCHIVO
...
class Producto(models.Model):
    ...
    imagen = models.ImageField(
        ...
        blank=True,
        null=True,
        help_text="Formatos permitidos: jpg, png, git. Tamaño máximo: 5MB"
    )
    ...
    class Meta:
        ...
        ordering = ['nombre'] #ORDENA POR NOMBRE AUTOMÁTICAMENTE
...
class MovimientoStock(models.Model):
    ...
    class Meta:
        ...
        ordering = ["-fecha"]  #ORDENA POR FECHA DESCENDIENTE, POR LO ÚLTIMO QUE INGRESÉ
